//
//  LSLocationHelper.swift
//  Haylou_Fun
//
//  Created by liubitao on 2022/1/6.
...
class LSLocationHelper: NSObject {
    ...
    //判断是否是有效坐标点
    static func isValid(point: CLLocationCoordinate2D) ->Bool {
        let longitude = point.longitude
        let latitude = point.latitude
        
        let longitudeCondition = longitude > -180 && longitude < 180
        let latitudeCondition = latitude > -90 && latitude < 90
