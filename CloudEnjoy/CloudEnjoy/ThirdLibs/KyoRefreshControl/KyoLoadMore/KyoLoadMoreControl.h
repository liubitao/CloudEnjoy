...
@property (assign, nonatomic, readonly) BOOL isLoadMore;  //是否正在加载更多
...
@property (nonatomic, copy) NSString *loadMoreButtonTitle;    //加载更多的按钮显示文字
...
- (void)resetInset:(UIEdgeInsets)inset; //重置inset
