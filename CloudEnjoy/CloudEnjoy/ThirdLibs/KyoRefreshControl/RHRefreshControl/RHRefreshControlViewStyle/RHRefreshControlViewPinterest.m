...
- (void)setImgContent:(UIImage *)imgContent {
    ...
    self.iconLayer.contents = (id)imgContent.CGImage;
}
...
- (void)commonSetupOnInit {
    ...
    _strokeColor = [UIColor colorWithRed:(float)0x3E/255.0 \
                                   green:(float)0x9D/255.0 blue:(float)0xFB/255.0 alpha:1.0];
//    _imgContent = [UIImage imageNamed:@"com_refresh_icon"];
     
//    _activityIndicatorColor = [UIColor colorWithRed:(float)0x3E/255.0 \
                                              green:(float)0x9D/255.0 blue:(float)0xFB/255.0 alpha:1.0];
