...
class LSClocksViewController: LSBaseViewController {
    var segmentedView: JXSegmentedView!
    var segmentedDataSource: JXSegmentedTitleDataSource!
    var listContainerView: JXSegmentedListContainerView!
    var subViewControllers = [LSClocksItemViewController]()
    ...
    override func setupData() {
        for type in LSTimeSectionType.allCases {
            self.subViewControllers.append(LSClocksItemViewController(timeSectionType: type))
        }
...
extension LSClocksViewController: JXSegmentedViewDelegate, JXSegmentedListContainerViewDataSource {
