...
class LSWorkbenchServer {
    ...
    static func getOrderInfo(billid: String) -> Single<LSYuyueOrderDetailsModel?> {
        return provider.lsRequest(.getOrderInfo(billid: billid)).mapHandyModel(type: LSYuyueOrderDetailsModel.self)
    }
